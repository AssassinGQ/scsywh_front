...
$(document).ready(function() {
    var trucksid = getCookie("trucksid");
    var token = getCookie("token");
    var data = {};
    data["token"] = token;
    data["trucksid"] = trucksid;
    data["corporationsid"] = getCookie("corporationsid");
    data["limit"] = 1;
    $.ajax({
        ...
        success:function (response) {
            if(response.status == 0){
                ...
                trucklog["lefttiretemp"] = (trucklog["lefttiretemp"]) + "℃";
                trucklog["righttiretemp"] = (trucklog["righttiretemp"]) + "℃";
